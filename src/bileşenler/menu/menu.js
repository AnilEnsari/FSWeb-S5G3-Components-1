...
*/
function menuYapici(menuElements) {
...
const menuCalistir = menuYapici(menuElemanlari);
const targetPlace = document.querySelector(".header");
targetPlace.append(menuCalistir);
